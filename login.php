...
<html lang="en">
    ...
    <head>
        ...
        <title>Felux - Login</title>
        <meta content="Client Login" name="Client Login Form" />
        <meta content="eSolution" name="Omer Maksuti" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    ...
    <body class="fixed-left">
        ...
        <div class="wrapper-page">
                ...
                <div class="card-body">
                    ...
                    <div class="p-3">
                        <div class="float-right text-right">
                            ...
                            <p class="text-muted">Sign in to continue to Felux.</p>
                            <?php
                                if(isset($_GET['error'])) {
            ...
            <div class="m-t-40 text-center text-white-50">
                <p>Are you a Inscructor ? <a href="inscructor/login.php" class="font-600 text-white"> Login Here </a> </p>
            </div>
